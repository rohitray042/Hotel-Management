...
<p class="text-justify">Full-service hotels often provide a wide array of guest services and on-site facilities. Commonly found amenities may include: on-site food and beverage (room service and restaurants), meeting and conference services and facilities, fitness center, and business center. Full-service hotels range in quality from mid-scale to luxury. This classification is based upon the quality of facilities and amenities offered by the hotel. [8] Examples include: Holiday Inn, Kimpton Hotels, Hilton, Marriott, and Hyatt Regency brands.</p>
  ...
  <div class="col-sm-2"style="background-color:#27303b;height:80px;width:100px;">
      <a href="#" type="button" data-toggle="modal" data-target="#myModal"><img src="img/icon/icon-01.png"width="60px;"height="50px;"style="margin-top:15px;"></a>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14695.025059559588!2d88.4477728!3d22.9592018!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe50dfccae21e1fc!2sJIS%20College%20of%20Engineering!5e0!3m2!1sen!2sin!4v1609576352560!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
    </div>
  </div>
</div>      
<!--Map Close Here-->
        ...
        <div class="col-sm-2">
          <h4><b>Address</b></h4>
          <b>Block A5 Kalyani,Nadia(West Bengal)</b>
        </div>
        <div class="col-sm-2"style="background-color:#27303b;height:80px;width:100px;">
            <a href="#"><img src="img/icon/icon-02.png"width="60px;"height="50px;"style="margin-top:15px;"></a>
        </div>
         <div class="col-sm-2">
          <h4><b>Phone</b></h4>
              <b>(+91) 88047914245</b>
        ...
        <div class="col-sm-2"style="background-color:#27303b;height:80px;width:100px;">
            <a href="#"><img src="img/icon/icon-03.png"width="60px;"height="50px;"style="margin-top:15px;"></a>
        </div>
         <div class="col-sm-2">
          <h4><b>Email-Id</b></h4>
              <b>flycomhotel@gmail.com</b>
        </div>
  </div><br><br>
</div>
</div>
