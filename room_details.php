...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="img/delux/delux_img1.jpg"class="thumbnail" alt="img1">
    </div>

    <div class="item">
      <img src="img/delux/delux_img2.jpg"class="thumbnail" alt="im2">
    </div>

    <div class="item">
       <img src="img/delux/delux_img3.jpg"class="thumbnail" alt="im3">
    </div>

    <div class="item">
       <img src="img/delux/delux_img4.jpg"class="thumbnail" alt="img4">
    </div>

    <div class="item">
       <img src="img/delux/delux_img5.jpg"class="thumbnail" alt="img5">
    </div>

    <div class="item">
       <img src="img/delux/delux_img7.jpg"class="thumbnail" alt="img7">
    </div>
  </div>
...
?>
    ...
    <div class="row">
      ...
      <img src="img/icon/wifi.png"class="img-responsive">
