       ...
       <div class="col-sm-6">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-8">
              <input type="text" class="form-control"  value="<?php echo $result['city']; ?>" name="city" placeholder="Enter Your City Name"required>
          </div>
        </div>
        </div>
        ...
        <div class="form-group">
          <div class="row">
           <div class="control-label col-sm-4"><h4>State</h4></div>
          <div class="col-sm-8">
		      ...
		      <div class="form-group">
            <div class="row">
           <div class="control-label col-sm-4"><h4>Zip Code</h4></div>
          <div class="col-sm-8">
              <input type="number" name="zip" class="form-control" placeholder="Enter Your Zip Code"required>
          </div>
        </div>
        </div>
        </div>
