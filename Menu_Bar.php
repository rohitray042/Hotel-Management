...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <img src="logo/fly.png"width="160px"height="50px"style="margin-top:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="Book_Flight/flight.php">Book Flight</a></li>
    </ul>
      ...
      if($_SESSION['create_account_logged_in']!="")
      {
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">View Status <span class="caret"></span></a>
        	<ul class="dropdown-menu">
              ...
              <li><a href="view.php">Booking Status</a></li>
